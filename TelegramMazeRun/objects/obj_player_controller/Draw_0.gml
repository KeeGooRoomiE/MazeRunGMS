...
draw_sprite_ext(spr_arrow,global.isSwipeUp,room_width/2,709-96,1,1,90,c_white,1);
draw_sprite_ext(spr_arrow,global.isSwipeLeft,room_width/2-128,709,1,1,180,c_white,1);
draw_sprite_ext(spr_arrow,global.isSwipeDown,room_width/2,709+96,1,1,270,c_white,1);
